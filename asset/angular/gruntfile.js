...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        clean: {
            ...
            api: ["API/src/main/resources/static/app"],
        ...
        copy: {
            main: {
                files: [
                    ...
                    {expand: true, cwd: "angular/app", src: ['index.html'], dest: "API/src/main/resources/static"}
                ]
            },
            main_js: {
                files: [
                    {expand: true, cwd: "angular/app", src: ['dist.min.js'], dest: "cordova/www"},
                    {expand: true, cwd: "angular/app", src: ['dist.min.js'], dest: "API/src/main/resources/static"}
                ]
            },
            plugin_js: {
                files: [
                    {expand: true, cwd: "angular/app", src: ['plugins.js'], dest: "cordova/www"},
                    {expand: true, cwd: "angular/app", src: ['plugins.js'], dest: "API/src/main/resources/static"}
                ]
            },
            main_css: {
                files: [
                    ...
                    {expand: true, cwd: "angular/app", src: ['dist.css'], dest: "API/src/main/resources/static"},
                    {expand: true, cwd: "angular/app", src: ['less.css'], dest: "API/src/main/resources/static"}
                ]
            },
            plugin_css: {
                files: [
                    {expand: true, cwd: "angular/app", src: ['plugins.css'], dest: "cordova/www"},
                    {expand: true, cwd: "angular/app", src: ['plugins.css'], dest: "API/src/main/resources/static"}
                ]
            },
            html: {
                files: [
                    ...
                    {
                        expand: true,
                        cwd: "angular/app/03-views",
                        src: ['**/*.html'],
                        dest: "API/src/main/resources/static/app/03-views"
                    }
                ]
            }
        },
