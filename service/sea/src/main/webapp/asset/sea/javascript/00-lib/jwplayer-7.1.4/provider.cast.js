webpackJsonpjwplayer([5], {
  156: function (a, b, c) {
    var d, e;
    d = [c(114), c(67), c(59), c(158), c(160), c(157), c(159), c(45), c(65), c(47)], e = function (a, b, c, d, e, f, g, h, i, j) {
      var k = function () {
      }, l = {}, m = function (m, n) {
        function o() {
        ...
        function p(a, b) {
          ...
          var c = {command: a};
          void 0 !== b && (c.args = b), A.sendMessage(g.NS, c, k, function (a) {
        ...
        function r(a, b) {
          ...
          if (c.reconcile) {
            ...
            var d = c.diff, e = E;
            d.id && c.appid && c.pageUrl || (d.id = window.jwplayer().id, c.appid = z.appid, c.pageUrl = C, E = A = null), d.id === m.id && c.appid === z.appid && c.pageUrl === C && (A || (o() && m.instreamDestroy(), this.sessionStarted(e), this.castModel.set("state", i.IDLE)), this.handleMessage(c)), E = null
          }
        }
        ...
        function w(a) {
          a /= 100, a = Math.max(0, Math.min(a, 1)), A.setReceiverVolumeLevel(a, G.mirrorVolume.bind(G), function (a) {
        ...
        var z, A = null, B = {available: !1, active: !1, deviceName: ""}, C = h.getAbsolutePath(window.location.href), D = null, E = null, F = null;
        z = j.extend({}, l, n.get("cast"));
        var G = this;
        this.onExistingSession = function (a) {
          g.log("existing session", a), A || E || (E = a.session, E.addMessageListener(g.NS, this.listenForHandshakeHandler))
        }, this.setActive = function (a) {
          B.active = !!a, B.deviceName = t(), this.castModel.set("castActive", !!a), this.castModel.set("deviceName", t()), this.castModel.set("castState", B)
          ...
          m.showView(m._view.element()), m.getProvider().name.indexOf("flash") >= 0 && n.resetProvider(), m.load(this.castModel.get("item")), m.play()
        }, this.sessionStopError = function (a) {
          g.error("Cast Session Stop error:", a, A), this.sessionStopped()
        }, this.sessionStarted = function (a) {
          if (g.log("Session started:", a), A)this.stopCasting(), F = a; else if (A = a, A.addMessageListener(g.NS, this.onMessageHandler), A.addUpdateListener(this.sessionStatusHandler), this.setupControllerForCasting(), a !== E) {
            var b = f.setupCastConfig(n, z);
            D.setup(b), d.sendDummyMedia(a)
          }
        }, this.sessionStatus = function (a) {
          g.log("Cast Session status", a), a ? this.mirrorVolume() : (this.castModel.set("state", i.BUFFERING), this.sessionStopped())
        }, this.sessionStopped = function () {
          g.log("_sessionStopped"), A && (this.removeSessionListeners(), A = null), D && (D.destroy(), D = null), this.setActive(!1), null !== F && (this.sessionStarted(F), F = null), this.resumePlayback()
        }, this.removeSessionListeners = function () {
          A.removeUpdateListener(this.sessionStatusHandler), A.removeMessageListener(g.NS, this.onMessageHandler)
          ...
          this.castModel.get("castAdPlaying") && (a.diff.newstate || a.diff.position) && this.castModel.set("castAdPlaying", !1), D.updateState(a.diff)
          ...
          var d = new c({castAvailable: !0, playlist: n.get("playlist"), playlistItem: n.get("playlistItem"), edition: n.get("edition")}), f = new b;
          this.castModel = f, f.setup(d), f.set("state", "playing"), f.setItem(0), f.changeVideoProvider(e), D = f.getVideo(), D.init(p, this.castModel);
          var g = y(f, D);
          g.castToggle = function () {
            this.stopCasting()
          }.bind(this);
          var h = new a(g, f);
          h.setup(), m.showView(h.element()), this.mirrorVolume(), this.setActive(!0)
        }, !z.appid || window.cast && window.cast.receiver || (d.on("availability", q), d.on("session", this.onExistingSessionHandler), d.initialize(z.appid)), this.onExistingSessionHandler = this.onExistingSession.bind(this), this.sessionStatusHandler = this.sessionStatus.bind(this), this.onMessageHandler = this.onMessage.bind(this), this.listenForHandshakeHandler = r.bind(this)
      };
      return m
    }.apply(b, d), !(void 0 !== e && (a.exports = e))
  }, 157: function (a, b, c) {
    var d, e;
    d = [c(45), c(47), c(58)], e = function (a, b, c) {
      function d(a, d) {
        var f = b.pick(a.getConfiguration(), ["displaytitle", "id", "item", "key", "mute", "playlist", "position", "repeat", "volume"]);
        return f.cast = b.extend({pageUrl: h}, d), e(f), f.edition = a.get("edition"), f.playerVersion = c, f
      }
    ...
    var d, e;
    d = [c(159), c(66), c(96), c(63), c(47)], e = function (a, b, c, d, e) {
      function f(d) {
        t = d, null !== a.availability ? u.trigger("availability", {availability: a.availability}) : p && p.cast ? h() : n || (n = new c(q), n.addEventListener(b.ERROR, i), n.addEventListener(b.COMPLETE, h), n.load())
      }
      ...
      function l(b) {
        u.trigger("session", {session: b}), b.sendMessage(a.NS, {whoami: 1}), 0 === b.media.length && g(b)
      }
      ...
      var n, o, p = window.chrome, q = "https://www.gstatic.com/cv/js/sender/v1/cast_sender.js", r = -1, s = 0, t = null, u = e.extend({initialize: f, sendDummyMedia: g}, d);
      return u
    }.apply(b, d), !(void 0 !== e && (a.exports = e))
  }, 160: function (a, b, c) {
    var d, e;
    d = [c(45), c(161), c(66), c(63), c(65), c(47), c(159)], e = function (a, b, c, d, e, f, g) {
      function h(c) {
        var d, e = c.get("castLoading"), f = c.get("playlistItem").title;
        d = e ? f ? "Loading " + f + " on " : "Loading on " : f ? "Casting " + f + " to " : "Casting to";
        var g = {message: d, deviceName: c.get("deviceName") || "Google Cast"};
        return a.createElement(b(g))
      }

      var i = function () {
        var b, i = -1, j = a.noop;
        f.extend(this, d), this.setState = function (a) {
          this.trigger(c.JWPLAYER_PLAYER_STATE, {newstate: a}), this.model.set("state", a)
        }, this.destroy = function () {
          clearTimeout(i)
        }, this.updateState = function (a) {
          if (a.newstate && this.setState(a.newstate.toLowerCase()), a.item && (this.setState(e.BUFFERING), this.model.setItem(a.item)), (void 0 !== a.position || void 0 !== a.duration) && (void 0 !== a.position && (this.lastPosition = a.position), void 0 !== a.duration && (this.lastDuration = a.duration), this.model.get("state") === e.BUFFERING && this.setState(e.PLAYING), this.trigger(c.JWPLAYER_MEDIA_TIME, {
              position: this.lastPosition,
              duration: this.lastDuration
            })), void 0 !== a.buffer && this.trigger(c.JWPLAYER_MEDIA_BUFFER, {bufferPercent: a.buffer}), a.tag) {
          ...
          j = a, this.model = b, this.model.on("change:item", this.updateScreen, this), this.model.on("change:deviceName", this.updateScreen, this), this._castingScreen = h(this.model)
          ...
          this.setState(e.BUFFERING), this.trigger(c.JWPLAYER_MEDIA_SEEK, {position: this.model.position, offset: a}), this.sendCommand("seek", a)
        ...
        }, this.volume = this.mute = this.setControls = this.setCurrentQuality = this.resize = this.seekDrag = this.addCaptions = this.resetCaptions = this.setVisibility = this.fsCaptions = a.noop, this.setFullScreen = this.getFullScreen = this.checkComplete = f.constant(!1), this.getWidth = this.getHeight = this.getCurrentQuality = f.constant(0), this.getQualityLevels = f.constant(["Auto"])
      };
      return i.prototype = {
        getName: function () {
