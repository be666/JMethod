webpackJsonpjwplayer([2], {
  105: function (a, b, c) {
    var d, e;
    d = [c(45), c(54), c(60), c(47), c(66), c(65), c(96), c(76), c(63)], e = function (a, b, c, d, e, f, g, h, i) {
      function j(j, m) {
        function n() {
        ...
        function t() {
          u(), H.trigger(e.JWPLAYER_MEDIA_TIME, {position: s(J.getCurrentTime()), duration: J.getDuration()})
        }

        function u() {
          var a = 0;
          J && J.getVideoLoadedFraction && (a = Math.round(100 * J.getVideoLoadedFraction())), L !== a && (L = a, H.trigger(e.JWPLAYER_MEDIA_BUFFER, {bufferPercent: a}))
        }

        function v() {
          H.state !== f.IDLE && H.state !== f.COMPLETE && (R = !0, H.trigger(e.JWPLAYER_MEDIA_BEFORECOMPLETE), H.setState(f.COMPLETE), R = !1, H.trigger(e.JWPLAYER_MEDIA_COMPLETE))
        }

        function w() {
          H.trigger(e.JWPLAYER_MEDIA_META, {duration: J.getDuration(), width: K.clientWidth, height: K.clientHeight})
        }
        ...
        function A(a) {
          ...
          switch (Q = a.data) {
            ...
            case b.ENDED:
              return void v();
            case b.PLAYING:
              return d.isFunction(J.unloadModule) && J.unloadModule("captions"), S = !1, w(), H.trigger(e.JWPLAYER_MEDIA_LEVELS, {
            ...
            case b.CUED:
              return void H.setState(f.IDLE)
          }
        }

        function B() {
          Q !== I.PlayerState.ENDED && H.play(), H.trigger(e.JWPLAYER_MEDIA_LEVEL_CHANGED, {currentQuality: H.getCurrentQuality(), levels: H.getQualityLevels()})
        }

        function C() {
          H.trigger(e.JWPLAYER_MEDIA_ERROR, {message: "Error loading YouTube: Video could not be played"})
        }
        ...
        function E() {
          clearInterval(P), J && J.stopVideo && a.tryCatch(function () {
        ...
        function F(b) {
          ...
          if (b.image || (b.image = "//i.ytimg.com/vi/" + d + "/0.jpg"), H.volume(m.volume), H.mute(m.mute), H.setVisibility(!0), !I || !J)return N = function () {
            y(d)
          }, void q();
          if (!J.getPlayerState) {
            var e = function () {
          ...
          if (f !== d) {
            ...
            var g = J.getPlayerState(), h = I.PlayerState;
            (g === h.UNSTARTED || g === h.CUED) && D()
          } else J.getCurrentTime() > 0 && J.seekTo(0), w()
        }

        this.state = f.IDLE, d.extend(this, i);
        var G, H = this, I = window.YT, J = null, K = document.createElement("div"), L = -1, M = !1, N = null, O = null, P = -1, Q = -1, R = !1, S = l;
        this.setState = function (a) {
          clearInterval(P), a !== f.IDLE && a !== f.COMPLETE && (P = setInterval(r, 250), a === f.PLAYING ? this.seeking = !1 : (a === f.LOADING || a === f.STALLED) && u()), h.setState.apply(this, arguments)
        }, !I && k && k.getStatus() === g.loaderstatus.NEW && (k.addEventListener(e.COMPLETE, n), k.addEventListener(e.ERROR, o), k.load()), K.id = j + "_youtube", this.init = function (a) {
          F(a)
          ...
          a = !!a, a ? (b.style(K, {display: "block"}), b.style(G, {visibility: "visible", opacity: 1})) : l || b.style(G, {opacity: 0})
          ...
          if (J.getAvailableQualityLevels) {
            var a = J.getPlaybackQuality(), b = J.getAvailableQualityLevels();
            return b.indexOf(a)
          }
          return -1
      ...
      var k = new g(window.location.protocol + "//www.youtube.com/iframe_api"), l = a.isMobile();
      return j.getName = function () {
        return {name: "youtube"}
      }, {
        register: function (a) {
